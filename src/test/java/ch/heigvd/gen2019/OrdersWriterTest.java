...
public class OrdersWriterTest {
    ...
    public void OneOrderWithOneProduct() {
        order111.AddProduct(new Product("Shirt", Product.Color.BLUE, Size.M, 2.99, "TWD"));
    ...
    public void OneOrderWithOneProductNoSize() {
        order111.AddProduct(new Product("Pot", Product.Color.RED, Size.SIZE_NOT_APPLICABLE, 16.50, "SGD"));
